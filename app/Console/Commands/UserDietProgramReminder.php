...
use App\Models\User;
use App\Notifications\UserDietProgramReminderNotification;
use Illuminate\Console\Command;
use Illuminate\Support\Facades\Notification;

class UserDietProgramReminder extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'command:user_diet_program_reminder';
        ...
        User::whereNotNull('diet_program_period')
            ...
            ->chunk(100, function ($users) {
                foreach ($users as $user) {
                    ...
                    Notification::send($user, new UserDietProgramReminderNotification());
                }
            });
    }
}
