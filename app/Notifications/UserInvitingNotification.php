...
class UserInvitingNotification extends Notification implements ShouldQueue
{
    private $coins;
    use Queueable;
    ...
    public function toFcm($notifiable)
    {
        ...
        $data = [
            ...
            'message' => str_replace('[coins]', number_format($this->coins), Lang::get('messages.user_inviting_notification_message')),
