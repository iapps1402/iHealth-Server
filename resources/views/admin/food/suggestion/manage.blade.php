@section('buttons')
    <button class="btn btn-secondary" type="button" onclick="window.location.href='{{ Route('admin_food_suggestion_add') }}'">افزودن پیشنهاد جدید</button>
@endsection
@section('container')
    ...
    <div id="table_main">
        @include('admin.food.suggestion.components.manage_table')
    </div>
